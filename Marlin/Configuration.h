...
#define STRING_CONFIG_H_AUTHOR "Blake" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Blake's E3Pro V1.5"
 ...
 */
#define X_DRIVER_TYPE A4988 // these are correct per the E on the SD card reader
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46.7, -5, 0 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_Z_HOP       6.0   // (mm) Z height of nozzle between leveling points - BS - try to skip clips
